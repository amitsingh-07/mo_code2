...
export class ManagementFormError {
  formFieldErrors: object = {
    ...
    withdrawAmount: {
      ...
      MinWithdrawal: {
        ...
        errorMessage: ' Please note that minimum withdrawal amount is $' + MANAGEMENT_CONSTANTS.WITHDRAW.MIN_WITHDRAW_AMOUNT + '.'
      },
      MinBalance: {
        errorTitle: 'Minimum Retention amount',
        errorMessage: 'Please note that minimum portfolio amount is $' + MANAGEMENT_CONSTANTS.WITHDRAW.MIN_BALANCE_AMOUNT + '. If you wish to maintain your portfolio, you are to maintain a minimum portfolio value of $' + MANAGEMENT_CONSTANTS.WITHDRAW.MIN_BALANCE_AMOUNT + ' or continue to redeem all.'
      }
    },
    withdrawPortfolio: {
      required: {
