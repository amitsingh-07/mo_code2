...
export class EmploymentDetailsComponent implements OnInit {
  ...
  addOrRemoveAdditionalControls(empStatus) {
    if (
      empStatus === INVESTMENT_ACCOUNT_CONSTANTS.EMPLOYEMENT_DETAILS.SELE_EMPLOYED ||
      empStatus === INVESTMENT_ACCOUNT_CONSTANTS.EMPLOYEMENT_DETAILS.EMPLOYED
    ) {
  ...
  addOtherIndustry(value) {
    if (value.industry === INVESTMENT_ACCOUNT_CONSTANTS.OTHERS) {
      this.employementDetailsForm.addControl(
        'otherIndustry',
  ...
  addOtherOccupation(value) {
    if (value.occupation === INVESTMENT_ACCOUNT_CONSTANTS.OTHERS) {
      this.employementDetailsForm.addControl(
        'otherOccupation',
        new FormControl(
          {
