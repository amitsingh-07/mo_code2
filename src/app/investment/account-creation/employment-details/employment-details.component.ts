...
export class EmploymentDetailsComponent implements OnInit {
  ...
  setEmploymentStatus() {
    if (this.formValues.companyName) {
      this.formValues.employmentStatus = ACCOUNT_CREATION_CONSTANTS.EMPLOYEMENT_DETAILS.EMPLOYED;
    } else {
      this.formValues.employmentStatus = ACCOUNT_CREATION_CONSTANTS.EMPLOYEMENT_DETAILS.UNEMPLOYED;
    }
  }

  addOrRemoveAdditionalControls(empStatus) {
    if (
      empStatus === ACCOUNT_CREATION_CONSTANTS.EMPLOYEMENT_DETAILS.SELE_EMPLOYED ||
      empStatus === ACCOUNT_CREATION_CONSTANTS.EMPLOYEMENT_DETAILS.EMPLOYED
    ) {
        ...
        new FormControl(
          {
            ...
            disabled: this.accountCreationService.isDisabled('companyName')
          },
  ...
  getIndustryList() {
    this.accountCreationService.getIndustryList().subscribe((data) => {
  ...
  getOccupationList() {
    this.accountCreationService.getOccupationList().subscribe((data) => {
  ...
  getEmployeList() {
    this.accountCreationService.getAllDropDownList().subscribe((data) => {
      ...
      this.accountCreationService.setEmploymentStatusList(
  ...
  addOtherIndustry(value) {
    if (value.industry === ACCOUNT_CREATION_CONSTANTS.OTHERS) {
      this.employementDetailsForm.addControl(
        'otherIndustry',
  ...
  addOtherOccupation(value) {
    if (value.occupation === ACCOUNT_CREATION_CONSTANTS.OTHERS) {
      this.employementDetailsForm.addControl(
        'otherOccupation',
        new FormControl(
          {
            value: this.formValues.otherOccupation,
            disabled: this.accountCreationService.isDisabled('otherOccupation')
          },
          Validators.required)
      );
    } else {
  ...
  goToNext(form) {
    if (!form.valid) {
      ...
      if (this.isEditProfile) {
        ...
        this.accountCreationService.setEmployeAddressFormData(form.getRawValue());
        this.router.navigate([ACCOUNT_CREATION_ROUTE_PATHS.FINANICAL_DETAILS]);
      }
    }
  }
