...
export class SelectPortfolioTypeComponent implements OnInit {
  ...
  buildPortfolioFormType() {
    ...
    if (this.selectedPortfolio) {
      this.selectedPortfolio === INVESTMENT_ENGAGEMENT_JOURNEY_CONSTANTS.PORTFOLIO_TYPE.JOINT_ACCOUNT ? this.portfolioTypeForm.controls['portfolioType'].setValue('2') : this.portfolioTypeForm.controls['portfolioType'].setValue('1');
    }
  }
}
