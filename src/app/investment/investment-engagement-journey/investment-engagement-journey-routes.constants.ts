...
export const INVESTMENT_ENGAGEMENT_JOURNEY_ROUTES = {
  ...
  CKA_UPLOAD: 'cka-upload-document',
  NONE_OF_THE_ABOVE: 'none-of-the-above',
  CKA_PASSED_SCREEN: 'passed-result',
  PORTFOLIO_APP_IN_PROGRESS: "portfolio-app-in-progress",
  SELECT_PORTFOLIO_GOAL_MORE_INFO: 'select-portfolio-goal-moreinfo'
};
...
export const INVESTMENT_ENGAGEMENT_JOURNEY_ROUTE_PATHS = {
  ...
  EDIT_SECONDARY_HOLDER_DETAILS: INVESTMENT_ENGAGEMENT_JOURNEY_BASE_ROUTE + INVESTMENT_ENGAGEMENT_JOURNEY_ROUTES.EDIT_SECONDARY_HOLDER,
  JA_UPLOAD_DOCUMENT: INVESTMENT_ENGAGEMENT_JOURNEY_BASE_ROUTE + INVESTMENT_ENGAGEMENT_JOURNEY_ROUTES.JA_UPLOAD_DOCUMENT,
  EDIT_UPLOAD_DOCUMENT: INVESTMENT_ENGAGEMENT_JOURNEY_BASE_ROUTE + INVESTMENT_ENGAGEMENT_JOURNEY_ROUTES.EDIT_JA_UPLOAD_DOCUMENT,
  CKA_ASSESSMENT: INVESTMENT_ENGAGEMENT_JOURNEY_BASE_ROUTE + INVESTMENT_ENGAGEMENT_JOURNEY_ROUTES.CKA_ASSESSMENT,
  CKA_UPLOAD_DOCUMENT: INVESTMENT_ENGAGEMENT_JOURNEY_BASE_ROUTE + INVESTMENT_ENGAGEMENT_JOURNEY_ROUTES.CKA_UPLOAD,
  NONE_OF_THE_ABOVE: INVESTMENT_ENGAGEMENT_JOURNEY_BASE_ROUTE + INVESTMENT_ENGAGEMENT_JOURNEY_ROUTES.NONE_OF_THE_ABOVE,
  CKA_PASSED_SCREEN: INVESTMENT_ENGAGEMENT_JOURNEY_BASE_ROUTE + INVESTMENT_ENGAGEMENT_JOURNEY_ROUTES.CKA_PASSED_SCREEN,
  PORTFOLIO_APP_INPROGRESS_SCREEN: INVESTMENT_ENGAGEMENT_JOURNEY_BASE_ROUTE + INVESTMENT_ENGAGEMENT_JOURNEY_ROUTES.PORTFOLIO_APP_IN_PROGRESS,
  SELECT_PORTFOLIO_GOAL_MORE_INFO: INVESTMENT_ENGAGEMENT_JOURNEY_BASE_ROUTE + INVESTMENT_ENGAGEMENT_JOURNEY_ROUTES.SELECT_PORTFOLIO_GOAL_MORE_INFO
};
