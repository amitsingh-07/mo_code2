...
export class ResidentialAddressComponent implements OnInit {
      ...
      address1: [
        {
          ...
          disabled: this.accountCreationService.isDisabled('address1')
        },
      ...
      address2: [
        {
          ...
          disabled: this.accountCreationService.isDisabled('address2')
        },
      ...
      isMailingAddressSame: [
        {
          ...
          disabled: this.accountCreationService.isDisabled('isMailingAddressSame')
        }
      ]
    });
  }
        ...
        new FormControl(
          {
            ...
            disabled: this.accountCreationService.isDisabled('postalCode')
          },
        ...
        new FormControl(
          {
            ...
            disabled: this.accountCreationService.isDisabled('floor')
          },
        ...
        new FormControl(
          {
            ...
            disabled: this.accountCreationService.isDisabled('unitNo')
          },
          [Validators.pattern(RegexConstants.SymbolNumber)]
        )
      );
        ...
        new FormControl(
          {
            ...
            disabled: this.accountCreationService.isDisabled('zipCode')
          },
          [Validators.required, Validators.pattern(RegexConstants.NumericOnly)]
        )
      );
          ...
          mailAddress1: [
            {
              ...
              disabled: this.accountCreationService.isDisabled('mailAddress1')
            },
            [
              Validators.required,
              Validators.pattern(RegexConstants.AlphanumericWithSymbol)
          ...
          mailAddress2: [
            {
              ...
              disabled: this.accountCreationService.isDisabled('mailAddress2')
            },
            [Validators.pattern(RegexConstants.AlphanumericWithSymbol)]
          ]
        })
        ...
        new FormControl(
          {
            ...
            disabled: this.accountCreationService.isDisabled('reasonForOthers')
          },
          Validators.required
        )
      );
        ...
        new FormControl(
          {
            ...
            disabled: this.accountCreationService.isDisabled('mailCity')
          },
        ...
        new FormControl(
          {
            ...
            disabled: this.accountCreationService.isDisabled('mailState')
          },
          [Validators.required, Validators.pattern(RegexConstants.OnlyAlphaWithoutLimit)]
        )
      );
        ...
        new FormControl(
          {
            ...
            disabled: this.accountCreationService.isDisabled('mailZipCode')
          },
          [Validators.required, Validators.pattern(RegexConstants.NumericOnly)]
        )
      );
  ...
  getDefaultCountry() {
    ...
    if (this.formValues.country) {
      ...
      defaultCountry = this.accountCreationService.getCountryFromNationalityCode(
        ACCOUNT_CREATION_CONSTANTS.SINGAPORE_NATIONALITY_CODE
      );
    } else {
      defaultCountry = this.accountCreationService.getCountryFromNationalityCode(
        this.formValues.nationalityCode
  ...
  goToNext(form) {
    if (form.status === 'DISABLED') {
      this.router.navigate([ACCOUNT_CREATION_ROUTE_PATHS.EMPLOYMENT_DETAILS]);
    } else if (!form.valid) {
      ...
      this.accountCreationService.setResidentialAddressFormData(form.getRawValue());
      this.router.navigate([ACCOUNT_CREATION_ROUTE_PATHS.EMPLOYMENT_DETAILS]);
    }
  }
  ...
  isDisabled(field) {
    ...
    if (field === 'country' && this.isUserNationalitySingapore) {
      ...
      isDisabled = this.accountCreationService.isDisabled(field);
    }
    return isDisabled;
  }
}
