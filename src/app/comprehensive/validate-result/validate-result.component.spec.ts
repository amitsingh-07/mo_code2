...
describe('ValidateResultComponent', () => {
 ...
 let injector: Injector;
  ...
  let router: Router;
  const route = ({ routeConfig: { component: { name: 'ValidateResultComponent' } } } as any) as ActivatedRoute;
  let httpClientSpy;
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ValidateResultComponent, ErrorModalComponent, StepIndicatorComponent],
      imports: [
        ReactiveFormsModule,
  ...
  it('should call go next', () => {
    ...
    expect(router.navigate).toHaveBeenCalledWith([COMPREHENSIVE_ROUTE_PATHS.REVIEW]);
  });
  it('should set page title', () => {
    const setPageTitleSpy = spyOn(navbarService, 'setPageTitleWithIcon');
    component.setPageTitle('CMP.VALIDATE_RESULT.TITLE');
    expect(setPageTitleSpy).toHaveBeenCalledWith('CMP.VALIDATE_RESULT.TITLE', { id: 'ValidateResultComponent', iconClass: 'navbar__menuItem--journey-map' });
  });
});
