...
export class MyEarningsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    for (const i in this.incomeDetailsDyn) {      
      if(this.earningDetails[this.incomeDetailsDyn[i]] !== null && this.earningDetails[this.incomeDetailsDyn[i]] !== '' && this.earningDetails[this.incomeDetailsDyn[i]]>0){
  ...
  showToolTipModal(toolTipTitle, toolTipMessage){
    let toolTipParams = { TITLE: this.translate.instant('CMP.MY_EARNINGS.TOOLTIP.'+toolTipTitle), 
