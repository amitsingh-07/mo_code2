...
describe('RiskProfileComponent', () => {
  ...
  let router: Router;
  const route = ({ routeConfig: { component: { name: 'RiskProfileComponent' } },snapshot: {
      data: {
        param: 1
      }
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [RiskProfileComponent, ErrorModalComponent, StepIndicatorComponent],
      imports: [
        ReactiveFormsModule,
...
{ provide: ActivatedRoute, useValue: route },
  ...
  it('should call go next', () => {
    ...
    component.goToNext(component.riskAssessmentForm);
  });
  it('should call go next', () => {
  
    component.save(component.riskAssessmentForm);
  });
  
    it('should call go next', () => {
      component.currentQuestion =1;
    component.setCurrentQuestion();
     component.riskAssessmentForm.controls.questSelOption.setValue(1);
