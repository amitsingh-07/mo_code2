...
describe('MyProfileComponent', () => {
  ...
  let router: Router;
  const route = ({ routeConfig: { component: { name: 'MyProfileComponent'} } } as any) as ActivatedRoute;
  let httpClientSpy;
  ...
  it('should set page title', () => {
    ...
    expect(setPageTitleSpy).toHaveBeenCalledWith('CMP.COMPREHENSIVE_STEPS.STEP_1_TITLE', { id: 'MyProfileComponent', iconClass: 'navbar__menuItem--journey-map' });
  });
});
