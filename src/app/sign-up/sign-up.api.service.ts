...
export class SignUpApiService {
 ...
 requestEmailOTP(journeyType, getAccountInfo) {
   ...
   */
  verifyLogin(userEmail, userPassword, captcha, finlitEnabled, accessCode, twoFaEnabled) {
    let enqId = -1;
    let journeyType = this.appService.getJourneyType();
    ...
    return this.authService.login(userEmail, this.cryptoService.encrypt(userPassword), captcha, sessionId, enqId, journeyType, finlitEnabled, accessCode, twoFaEnabled);
  }
