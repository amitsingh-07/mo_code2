...
export const SIGN_UP_ROUTE_PATHS = {
  ...
  LOGIN2: SIGN_UP_BASE_ROUTE + SIGN_UP_ROUTES.LOGIN2,
  UPGRADE: SIGN_UP_BASE_ROUTE + SIGN_UP_ROUTES.UPGRADE,
  CORPBIZ_LOGIN: SIGN_UP_BASE_ROUTE + SIGN_UP_ROUTES.CORPBIZ_LOGIN,
