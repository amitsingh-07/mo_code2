export const RegexConstants = {
    PassportNumber: /^[a-zA-Z0-9]{3,}$/, // Min 3 alphanumeric
    ...
    cpfOperatorMask: {
        DBS: [/\d|\*/, /\d|\*/, /\d|\*/, '-', /\d|\*/, /\d|\*/, /\d|\*/, /\d|\*/, /\d|\*/, /\d|\*/, /\d|\*/, '-', /\d|\*/, /\d|\*/, /\d|\*/], /* 3-7-3 */
        OCBC: [/\d|\*/, /\d|\*/, '-', /\d|\*/, /\d|\*/, /\d|\*/, /\d|\*/, /\d|\*/, '-', /\d|\*/, /\d|\*/], /* 2-5-2 */
        UOB: [/\d|\*/, /\d|\*/, '-', /\d|\*/, /\d|\*/, /\d|\*/, /\d|\*/, /\d|\*/, '-', /\d|\*/, /\d|\*/], /* 2-5-2 */
    },
    ...
    cpfOperatorMaskForValidation: {
        DBS: /^\d{3}-?\d{7}-?\d{3}$/, /* 3-7-3 */
        OCBC: /^\d{2}-?\d{5}-?\d{2}$/, /* 2-5-2 */
        UOB: /^\d{2}-?\d{5}-?\d{2}$/, /* 2-5-2 */
    },
