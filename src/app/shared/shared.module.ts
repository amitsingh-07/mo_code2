...
import { WiseIncomePayoutComponent } from './components/wise-income-payout/wise-income-payout.component';
...
@NgModule({
  ...
  exports: [CurrencyInputDirective, PercentageInputDirective, CapsLockInputDirective, PlanWidgetComponent, StepIndicatorComponent, SettingsWidgetComponent,
    ...
    CopyClipboardDirective, WiseIncomePayoutComponent, WiseIncomeFundComponent],
