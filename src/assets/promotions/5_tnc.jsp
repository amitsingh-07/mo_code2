...
<ol class="tnc--ordered">
    ...
    <li>For Table A, qualifying customer will enjoy the premium discount from their first year annual premium or single premium upon application for the Qualifying Product(s).</li>
    <li>For Table B, qualifying customer will receive the cash reward 2 months after the first year policy anniversary.</li>
